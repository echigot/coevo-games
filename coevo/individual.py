...
def play_one_game(agentInd=AgentInd(), envInd=EnvInd(), render=False, level_string=None, video=False, title=None):
    if title==None:
        title="video_coevo_4.mp4"
    ...
    if video:
        ...
        frame = env.render()
        video_recorder.start(title, frame.shape)
